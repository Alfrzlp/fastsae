...
// eblup_core
List eblup_core(const arma::mat& X, const arma::vec& y, const arma::vec& vardir, std::string method, int maxiter, double precision);
RcppExport SEXP _fastsae_eblup_core(SEXP XSEXP, SEXP ySEXP, SEXP vardirSEXP, SEXP methodSEXP, SEXP maxiterSEXP, SEXP precisionSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(eblup_core(X, y, vardir, method, maxiter, precision));
